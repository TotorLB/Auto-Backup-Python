...
# Note : Ne pas supprimer les "," placées après chaque classe afin de garantir le bon fonctionnement du script.
# Note : Do not delete those "," set behind each class to make sure everything works properly.
